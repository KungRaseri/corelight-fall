<script lang="ts">
	...
	// State
	let sidebarNavigationValue = $state('files');
	let sidebarNavigationIsExpanded = $state(false);
...
<div class="grid h-screen grid-rows-[auto_1fr_auto]">
	...
	<div class="grid grid-cols-1 md:grid-cols-[auto_1fr]">
		<!-- Left Sidebar. -->
		<aside class="card grid h-full w-full grid-cols-[auto_1fr]">
			<Navigation.Rail
				value={sidebarNavigationValue}
				onValueChange={(newValue) => (sidebarNavigationValue = newValue)}
				expanded={sidebarNavigationIsExpanded}
			>
				{#snippet tiles()}
					<Navigation.Tile id="files" label="Files" labelExpanded="Browse Files"
						><IconFolder /></Navigation.Tile
					>
					<Navigation.Tile id="images" label="Images" labelExpanded="Browse Images"
						><IconImage /></Navigation.Tile
					>
					<Navigation.Tile id="music" label="Music" labelExpanded="Browse Music"
						><IconMusic /></Navigation.Tile
					>
					<Navigation.Tile id="videos" label="Videos" labelExpanded="Browse Videos"
						><IconVideo /></Navigation.Tile
					>
				{/snippet}
			</Navigation.Rail>
		</aside>
