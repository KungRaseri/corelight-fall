...
{:else}
	...
	<button class="btn preset-filled-primary-500 mb-4" onclick={addStoryline}>Add New Storyline</button>
	{#if loading}
		<p>Loading...</p>
	{:else}
				...
				{#each storylines as storyline}
					<tr class="border-surface-700 hover:bg-surface-700 border-t transition">
						...
						<td class="flex gap-2 px-3 py-2">
							<button class="btn preset-filled-primary-500 px-1 py-0.5 text-xs" onclick={() => editStoryline(storyline)}
								>Edit</button
							>
